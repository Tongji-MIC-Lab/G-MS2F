...
/home/tj/caffe-master-aki/build/tools/caffe multi_view_test -gpu=1 --weights=/home/tj/newdisk/tpj/MIT/MIT_models_googlenet_place205_withpre_relu_2/MIT_stage2_iter_30000.caffemodel --model=train_val_googlenet_places205_stage2.prototxt --iterations=1340 --class_num=67 --outfile_name=_iter_30000_stage2 --use_mirror=true
