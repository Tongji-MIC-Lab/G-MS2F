...
/home/tj/caffe-master-aki/build/tools/caffe multi_view_test -gpu=1 --weights=/home/tj/newdisk/tpj/MIT/MIT_models_googlenet_place205_withpre_relu/MIT_iter_20000.caffemodel --model=train_val_googlenet_places205.prototxt --iterations=1340 --class_num=67 --outfile_name=_iter_20000_1 --use_mirror=true
